...
/**
 * Tree is a class representing a kind of generalized tree that the user wishes
 * to draw on a graphics plane or print on some page (or graphics plane).
 *
 * A tree of this kind has data and any number of children. The data is simply a
 * String and the children is a Vector of Tree's.
 *
 * A Tree can draw itself on any appropriate graphics plane using its drawTree
 * method. A Tree can print itself at TTY (or elsewhere) via its toString
 * method.
 *
...
public class Tree {
    ...
    /**
     * .toString() .toString(int) Generate a String representation for the
     * entire tree This is the familiar cascaded (tabbed tree) form.
     */
    ...
    /**
     * drawTree draws the tree in the Graphics plane using upper-left corner x,y
     * (for box containing the tree).
     */
